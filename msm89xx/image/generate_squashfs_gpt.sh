...
#
# Samsung Galaxy J5 2015 (J500G)
# eMMC size:
# 15269888 sectors * 512 bytes
#

TOT_SECTORS=15269888
...
[ ${ROOTFSDATA_SIZE} -gt 0 ] || {
    echo "ERROR: No space left for rootfs_data"
    exit 1
}
...
gpt.img13 : start=${BOOT_START}, size=${BOOT_SIZE}, \
type=20117F86-E985-4357-B9EE-374BC1D8487D, name="boot"

gpt.img14 : start=${ROOTFS_START}, size=${ROOTFS_SIZE}, \
type=1B81E7E6-F50D-419B-A739-2AEEF8DA3335, name="rootfs"

gpt.img15 : start=${ROOTFSDATA_START}, \
type=1B81E7E6-F50D-419B-A739-2AEEF8DA3335, name="rootfs_data"
EOF

#
# Generate gpt_both0.bin
#
